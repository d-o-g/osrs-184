...
public class JagGraphics3D extends JagGraphics {
    ...
    public static final int[] colorPalette = new int[65536];
    ...
    public static void method619(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
        ...
        if (var19 == null) {
            ...
            if (var29 != 0) {
                ...
                int var33 = (int) (((long) (var15 * var14 - var17 * var12) << 3 << 14) / (long) scale);
                int var34 = (int) (((long) (var17 * var9 - var11 * var15) << 14) / (long) scale);
                int var35 = var10 * var12 - var13 * var9 << 14;
                int var36 = (int) (((long) (var13 * var15 - var16 * var12) << 3 << 14) / (long) scale);
                int var37 = (int) (((long) (var16 * var9 - var10 * var15) << 14) / (long) scale);
                int var38 = var13 * var11 - var10 * var14 << 14;
                int var39 = (int) (((long) (var16 * var14 - var13 * var17) << 3 << 14) / (long) scale);
                int var40 = (int) (((long) (var17 * var10 - var11 * var16) << 14) / (long) scale);
                int var41;
                if (var0 <= var1 && var0 <= var2) {
                    if (var0 < anInt702) {
                        if (var1 > anInt702) {
    ...
    public static void method638(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
        ...
        if (var19 == null) {
            ...
            if (var29 != 0) {
                ...
                var17 -= var15;
                int var32 = var11 * var12 - var9 * var14 << 14;
                int var33 = (int) (((long) (var15 * var14 - var17 * var12) << 14) / (long) scale);
                int var34 = (int) (((long) (var17 * var9 - var11 * var15) << 14) / (long) scale);
                int var35 = var10 * var12 - var13 * var9 << 14;
                int var36 = (int) (((long) (var13 * var15 - var16 * var12) << 14) / (long) scale);
                int var37 = (int) (((long) (var16 * var9 - var10 * var15) << 14) / (long) scale);
                int var38 = var13 * var11 - var10 * var14 << 14;
                int var39 = (int) (((long) (var16 * var14 - var13 * var17) << 14) / (long) scale);
                int var40 = (int) (((long) (var17 * var10 - var11 * var16) << 14) / (long) scale);
                int var41;
                if (var0 <= var1 && var0 <= var2) {
                    if (var0 < anInt702) {

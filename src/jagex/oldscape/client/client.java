...
import jagex.jagex3.client.input.mouse.MouseWheel;
...
import jagex.oldscape.client.minimenu.*;
...
import jagex.oldscape.shared.prot.friends.FriendLoginUpdate;
import jagex.messaging.handler.*;
import jagex.oldscape.shared.prot.login.*;
...
public final class client extends GameShell implements LocalPlayerNameProvider {
  ...
  protected void method745() {
    ...
    if (var4 != null) {
      WorldMapController.osName = var4;
    }
  ...
  public boolean processIncomingPacket() {
    ...
    try {
      ...
      if (ServerProt.OPEN_BROWSER_URL == stream.currentIncomingPacket) {
        ...
        Browser.openURL0(url, true, false);
        stream.currentIncomingPacket = null;
        return true;
      }

...
import jagex.oldscape.ComponentFillType;
...
import jagex.oldscape.client.minimenu.ItemSelection;
import jagex.oldscape.client.social.FriendChatUser;
import jagex.oldscape.client.scene.SceneGraph;
import jagex.oldscape.client.scene.SceneOccluder;
...
public class InterfaceComponent extends Node {
  ...
  public Model method956(AnimationSequence var1, int var2, boolean var3, PlayerModel var4) {
    ...
    Model var7 = models.get(var6 + ((long) var5 << 16));
    if (var7 == null) {
      UnlitModel var8;
      if (var5 == 1) {
      ...
      models.put(var7, var6 + ((long) var5 << 16));
    }
